...
public class PromotionController {
    ...
    public ResponseEntity<PromotionOutDto> createPromotion(@RequestBody PromotionInDto promotionInDto) {
        PromotionDomain promotionDomainSaved = promotionService.createPromotion(this.toDomain(promotionInDto));
        return ResponseEntity.status(ResponseUtil.SUCCESS).body(this.toPromotionOutDto(promotionDomainSaved));
    }
    ...
    public ResponseEntity<PromotionOutDto> getPromotionById(@PathVariable("id") String id){
        ...
        return ResponseEntity.status(ResponseUtil.SUCCESS).body(this.toPromotionOutDto(promotionDomain));
    }
